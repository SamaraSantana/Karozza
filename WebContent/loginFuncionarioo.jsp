                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Karozza</strong> Rent a car</h1>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="efetuaLoginFuncionario"method="post" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">Login</label>
			                        	<input type="text" name="login" placeholder="Login..." class="form-username form-control" id="login">
			                        </div>
			                        <div class="form-group">
			                        ...
			                        <div class="form-group">
			                        	<select class="form-user form-control"  name="tipo" id="tipo">
