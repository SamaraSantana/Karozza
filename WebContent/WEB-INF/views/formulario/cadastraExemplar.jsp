...
<form name="form1" class="form-horizontal"    action="adicionaExemplar" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input class="form-control" id="placa"  onblur="testaPlaca(this.value)" name="placa" type="text" />
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input class="form-control" id="renavam" onkeypress='return SomenteNumero(event)'  name="renavam" type="text" />
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input class="form-control" id="chassi" onkeypress='return SomenteNumero(event)'  name="chassi" type="text" />
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input class="form-control" onkeypress='return SomenteNumero(event)'  id="odometro" name="odometro" type="text" />
                        </div>
                    </div>    
        ...
        <div class="form-group">
                        <label class="col-lg-3 control-label">Onde está esse veículo?</label>
                        <div class="col-lg-5">
        ...
        <div class="form-group">
                        ...
                        <div class="col-lg-5">
		<select class="form-control"  class="automovel" name="automovel">
		 <option disabled="disabled" value="" selected="selected">Selecione</option>
