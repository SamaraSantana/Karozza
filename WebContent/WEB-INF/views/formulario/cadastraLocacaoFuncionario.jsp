...
<body>
	<form name="form1" action="adicionaLocacaoFuncionario" method="get">
		...
		<div id="nav"  style=" width: 900px;margin-top: 30px;">
			...
			<div class="tab_container">
				...
				<div class="col-lg-12">
					<div id="LocacaoDataHora" class="cont_tab">
						...
						<input type="text" class="form-control" name="data_Retirada"
							id="R_Data" placeholder="Quando?" mask="##/##/####" maxlength="" />
						...
						<input type="text" class="form-control" name="data_Prevista"
							id="D_Data" placeholder="Quando?" mask="##/##/####" maxlength=""
				...
				<div id="LocacaoGrupo" class="cont_tab">
					...
					<table>
						...
						<c:if test="${grupos.loja eq locacao.local_Reserva}">
								<tr>
									...
									<td><h4>
											<input type="radio" name="grupo" class="radio-custom"
												value="${grupos.id}"
					...
					<br />
					<label class="title" for="title">Veiculos disponiveis:</label>
					<table>
					...
					<table>
						<c:forEach items="${protecoes}" var="protecoes">
							...
							<tr>
								...
								<td><h4>
										<input type="radio" class="radio-custom" name="protecao"
											value="${protecoes.id}"
				...
				<div id="LocacaoFinalizar" class="cont_tab">
					...
					<div class="col-lg-6">
						...
						<h4>
							<label> Sexo:<br /> <input type="radio" name="sexo"
								value="Masculino" id="tipo" required> Masculino
							</label><br />
						</h4>
						<h4>
							<label> <input type="radio" name="sexo" value="Feminino"
								id="tipo" required> Feminino
							</label>
						</h4>
					...
					<div class="col-lg-6">
						...
						<input name="cep" type="text" id="cep" maxlength="9"
							...
							required="required" onkeypress='return SomenteNumero(event)' /><br />
					</div>
					...
					<p>
					<hr>
					<input class="btFinalizar" type="submit" name="bt_gravar"
						id="bt_gravar" value="finalizar reserva">
					<hr>
					</p>
				</div>
			</div>
