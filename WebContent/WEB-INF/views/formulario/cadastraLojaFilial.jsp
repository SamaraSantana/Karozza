                    ...
                    <div class="col-lg-12">
                      ...
                      Loja Filial
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-edit"></i> Loja filial
                        </ol>
                    </div>
                </div>
	<form name="form1" class="form-horizontal" action="adicionaLoja" method="get">

   <div class="form-group">
                        <label class="col-lg-3 control-label">Cnpj</label>
                        <div class="col-lg-5">
                            <input class="form-control" id="cnpj" name="cnpj"   onKeyPress="MascaraCNPJ(form1.cnpj);" 
