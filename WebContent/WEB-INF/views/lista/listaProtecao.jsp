                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-automobile "></i> Proteções
                        </ol>
                    </div>
                </div>
			<table>
				...
				<tbody>
					...
					<c:forEach items="${protecoes}" var="protecoes">
						...
						<tr>
							<td>${protecoes.id}</td>
							<td>${protecoes.descricao}</td>
							<td>${protecoes.preco}</td>
							
							<td><a href="alterarP?id=${protecoes.id}"><img
									src="resources/edit.png" /></a></td>
							<td><a href="removerProtecao?id=${protecoes.id}"><img
