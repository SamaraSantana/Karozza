        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-automobile "></i> Multas
			...
			<table>
				...
				<tbody>
					...
					<c:forEach items="${multas}" var="multas">

						<tr>
							<td>${multas.id}</td>
							<td>${multas.data}</td>
							<td>${multas.infracao}</td>
							<td>${multas.exemplar}</td>
							<td><a href="alterarM?id=${multas.id}"><img
									src="resources/edit.png" /></a></td>
							<td><a href="removerMulta?id=${multas.id}"><img
