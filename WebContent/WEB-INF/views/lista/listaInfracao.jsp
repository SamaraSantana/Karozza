        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-automobile "></i> Infrações
			...
			<table>
				...
				<tbody>
					...
					<c:forEach items="${infracoes}" var="infracoes">

						<tr>
							<td>${infracoes.id}</td>
							<td>${infracoes.descricao}</td>
							<td>${infracoes.gravidade}</td>
							<td>${infracoes.codigo}</td>
							<td>${infracoes.pontos}</td>
							<td>${infracoes.preco}</td>
							<td><a href="alterarI?id=${infracoes.id}"><img
									src="resources/edit.png" /></a></td>
							<td><a href="removerInfracao?id=${infracoes.id}"><img
