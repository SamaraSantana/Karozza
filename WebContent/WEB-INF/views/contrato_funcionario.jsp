...
<div class="dados">
		...
		<h3>Dados da retirada</h3>
		   ...
		   <%--FORMATANDO DATAS --%>
	<div class="seila"><c:set var="data" value="<%=new java.util.Date() %>" />
Data devolução: <fmt:formatDate type="date" value="${data }" pattern="dd/MM/yyyy"/></div>


	<div class="seila">Hora devolução: <fmt:formatDate type="time" value="${data }" pattern="H:m"/></div>
<%-- H= hora atual / m=minuto / D=diano / w=diaSemana / W=mes entre outros --%>
...
<div class="item">
	...
	<div id="total">	
			<h4>Valor Total</h4>
			<h4><div class="seila">R$ ${resumoGrupo.preco * dias + resumoProtecao.preco * dias + somaOpcionais * dias}</div></h4>
	</div>
	...
	<div id="total">	
			...
			<small>Assinatura</small></h3>
	</div>
	</div>	
	<div id="bts">
			
				<a href="adm"><input  type="button"  value="Inicio" class="bt" style="margin-left: 300px;"/></a>
	
	<button class="bt" id="btn" style="margin-left: 100px;" >Clique para imprimir</button>
</div>
