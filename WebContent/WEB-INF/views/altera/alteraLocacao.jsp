...
<div class="col-lg-3 col-sm-4 ">
	...
	<h4><span class="glyphicon glyphicon-tags"></span>Grupo - Descrição - Preço</h4>
...
<br>
	...
	<form name="form1" action="alteraLocacao" method="get">
		...
		<div id="nav">
			...
			<div class="tab_container">
								...
								<c:if test="${grupos.id == grupoLocacao.id}">
									<td><h4>
											<input type="radio" name="grupo"   class="radio-custom" value="${grupos.id}"
												id="${grupos.nome} - ${grupos.descricao} - R$ ${grupos.preco}" checked="checked">
							...
							<tr>
								...
								<c:if test="${protecoes.id == protecaoLocacao.id}">
									<td><h4>
											...
											id="${protecoes.descricao} ........... R$ ${protecoes.preco}" checked="checked">
								...
								<c:forEach items="${opcionalLocacao}" var="opcionalLocacao">
									<c:if test="${opcionais.id == opcionalLocacao.id}">
										<td><h4>
											...
											onclick="verificaChecks()" checked="checked" disabled="disabled" >
									...
									<c:if test="${opcionais.id != opcionalLocacao.id}">
										<td><h4>
											...
											value="${opcionais.id}"
											id="${opcionais.nome} - R$ ${opcionais.preco}"
											onclick="verificaChecks()"  disabled="disabled" >
											<label value="${opcionais.id}" for="${opcionais.nome} - R$ ${opcionais.preco}" class="checkbox-custom-label" onclick="verificaChecks()">Selecionar</label>
											</h4></td>
									</c:if>
								</c:forEach>
				...
				<div id="LocacaoFinalizar" class="cont_tab">
					<input type="hidden" name="cliente" value="${usuarioLogado.id}">
					 <div class="col-lg-6">
					<h4>
					...
					<input type="text" name="nome" id="nome" class="form-control" value="${usuarioLogado.nome}">
					</div>
					 <div class="col-lg-6">
					<h4>
 ...
 <div class="col-lg-6">
					...
					<input type="text" name="cpf" id="cpf" class="form-control"  maxlength="11" onKeyPress="return Apenas_Numeros(event);" value="${usuarioLogado.cpf}" onBlur="validaCPF(this);">
</div>
...
<div class="col-lg-6">
 ...
 <label for="rg">RG:</label>
        ...
        <input type="text" name="rg" id="rg"  maxlength="12" required="required" class="form-control" onKeyPress="MascaraRG(form1.rg);"  value="${usuarioLogado.rg}" onkeypress='return SomenteNumero(event)'>
        </div>
...
<label for="dataNascimento">Data de Nascimento:</label>
        ...
        <input type="date" class="form-control" name="dataNascimento" id="dataNascimento"value="${usuarioLogado.dataNascimento}" required="required" maxlength="10" name="date" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" min="01-01-2012" max="18-02-2016" />
        </div>
        ...
        <input name="cep" type="text" id="cep"  maxlength="9"
               onblur="pesquisacep(this.value);" class="form-control"required="required" value="${usuarioLogado.cep}"   onkeypress='return SomenteNumero(event)'  /><br />
         </div>
        ...
        <input type="text" name="rua" class="form-control" required="required" value="${usuarioLogado.rua}"  id="rua" >
        </div>
        ...
        <input type="text" name="complemento" class="form-control" value="${usuarioLogado.complemento}" id="complemento" >
        </div>
        ...
        <input type="text" name="numRua" class="form-control" required="required"  value="${usuarioLogado.numRua}"  onkeypress='return SomenteNumero(event)'  id="numRua" >
        </div>
        ...
        <input name="bairro" type="text" id="bairro" class="form-control" required="required" value="${usuarioLogado.bairro}"  />
         </div>
        ...
        <input name="cidade" type="text" id="cidade" class="form-control"  value="${usuarioLogado.cidade}" required="required"   /><br />
        ...
        <input name="uf" type="text" id="uf" required="required" class="form-control" value="${usuarioLogado.uf}"  />
        ...
        <input type="text" name="cnh"  onkeypress='return SomenteNumero(event)' maxlength="11" class="form-control"value="${usuarioLogado.cnh}" required="required"  id="cnh" >
        </div>
        ...
        <input type="date" name="validadeCnh" id="validadeCnh" class="form-control" required="required" value="${usuarioLogado.validadeCnh}" maxlength="10" name="date" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" min="01-01-2012" max="18-02-2016" />
        </div>
        ...
        <label for="emissaoCnh">Emissão:</label>
          ...
          <input type="date" name="emissaoCnh" id="emissaoCnh" class="form-control" required="required"  value="${usuarioLogado.emissaoCnh}" maxlength="10" name="date" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" min="01-01-2012" max="18-02-2016" />
        </div>
	...
	<script type="text/javascript">
		function resumoLocacaoDataHora() {
			...
			var txt6 = document.getElementById("grupos");
			document.getElementById("divAutomovel").innerHTML = "Hora de Previsão: "
					+ txt6.value;
		}
