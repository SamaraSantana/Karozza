...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="teste">Home</a> / Modelos de carros</span>
 ...
 <c:forEach items="${grupos}" var="grupos">
     ...
     <!-- properties -->
      ...
      <div class="properties">
        ...
        <div class="image-holder"><img class="img"
												src="data:image/jpeg;base64, ${grupos.foto64 }" class="img-responsive" alt="properties">
         
        </div>
        <h4><a href="carrosKarozza">${grupos.nome} ${grupos.descricao}</a><br><br></h4>
